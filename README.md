...
<p align="center">
  <img src="images/logo.png" alt="PapyConnect Logo" width="400" />
</p>
...
- **CLI Debug (Scanned Devices Tree)**:
  ...
  # View scanned devices grouped and ordered by application name
  make status byapp
  ...
  ```
  *(Fetches scanned network devices and applications. If `byapp` is specified, it groups and prints devices ordered by available application/game names. If `add name=ip` is specified, it registers the device on the backend before printing).*
